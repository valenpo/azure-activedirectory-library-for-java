...
class HttpHelper {
    ...
    static HttpsURLConnection setTimouts(HttpsURLConnection conn) {
    ...
    static String readResponseFromConnection(final HttpsURLConnection conn)
        ...
        try (final Reader inReader = new InputStreamReader(conn.getInputStream());
